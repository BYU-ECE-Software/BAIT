...
async function checkExistingConversation(userId: number, campaignId: number, characterId: number, sentfrom: string) {
...
async function writeConversation(userId: number, campaignId: number, characterId: number, sentfrom: string) {
    const prisma = new PrismaClient();
    try {
...
export default async function dbCreateConversation(userId: number, campaignId: number, characterId: number, sentfrom: string) {
    const existingConversation = await checkExistingConversation(userId, campaignId, characterId, sentfrom);
    ...
    const response = await writeConversation(userId, campaignId, characterId, sentfrom);
    return response;
}