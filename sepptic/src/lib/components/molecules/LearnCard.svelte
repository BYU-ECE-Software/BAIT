...
<div  class="w-full max-w-3xl mx-auto">
    <Card img="/SocialEngineering.jpeg" class="w-full">
        ...
        <Button class="dark:hover:bg-seppticOrange-700 bg-seppticOrange-600 dark:bg-seppticOrange-600 hover:bg-seppticOrange-700 text-white focus:ring-4 focus:ring-seppticOrange-400 focus:outline-none w-full" href="/main/learn">
            Learn Here
        </Button>
    </Card>
